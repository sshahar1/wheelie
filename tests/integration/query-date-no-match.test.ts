...
describe('User Story 2: ask about a specific date with no match', () => {
  ...
  it('clearly states no performance is scheduled for the queried date instead of fabricating one', async () => {
    ...
    expect(ctx.sentMessages[0].body.toLowerCase()).toContain('no performance is scheduled for');
